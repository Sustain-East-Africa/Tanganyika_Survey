...
SEA_palette <- c("#3d5919",  "#5b7a2e",  "#a4b792", "#d2d2c8", "#404b58", "#b9c9b1", "#839c7a",  "#293c14", "#151d29", "#d77e5e", "#e6e7e2",  "#202C39", "#381D2A", "#000000", "#f2a084", "#f0f1ed",  "#522a3b", "#1a1a1a", "#b15e42",   "#2a171e", "#3c3c3c")

SEA_palette_2 <- c( "#d2d2c8", "#5b7a2e", "#a4b792")

SEA_palette_3 <- c(
  "#3d5919", # Deep earthy green
  "#5b7a2e", # Olive green
  "#d2d2c8", # Neutral beige
  "#88CC88", # Soft green
  "#DDCC77", # Muted yellow
  "#AA4499", # Earthy plum
  "#44AA99", # Turquoise
...
cluster_1_villages <- c("Isasa", "Kalungu", "Kichangani", "Kipili", 
                        "Majengo Mapya", "Manda Kerenge", "Manda Uhuru", 
                        "Mkinga", "Mtakuja", "Ntanganyika", "Overall North", "Overall")

cluster_2_villages <- c("Izinga", "Kala", "Katenge", "Kilambo cha Mkolechi", 
                        "Kizumbi", "Lyapinda", "Mpasa", "Mwinza", "Ng'anga", 
                        "Tundu", "Wampembe", "Overall South")
...
Brehony, P., Bachmann, T., Muiyuro, R. 2024. Baseline Study for the Lake Tanganyika Programme: Household Socioeconomic Assessment. Sustain East Africa, Nairobi, Kenya.

### Acknowledgements

The authors of this report would like to extend their gratitude to Craig Leisher, Lucy Mlagala, Camilla Herd, Fridolin Nzambimana, Ahmadi Mkali, and Peter Limbu for their support and technical assistance in producing this report. Furthermore, we would like to thank Joseph Emmanuel Sikorei, Monica Mbogo Mabula, Masanja Bahati Limbu, Aloyce Filbert Lumbert, Saning’o Richard Mollel, Jamila Athumani Mkwizu, Assa Amon Hamad, Zuhura Sharifu Kulanga, Jesca Andrea Baroga, and Linda Shubi Charles for their invaluable assistance as enumerators in conducting all the household surveys, as well as Sophia Shaban, Christina Misana, and Sood Ndimuligo for acting as supervisors to the team. We would also like to extend a special thank you to Dominico Kilemo from ENVEX who led the data collection stage, and Noel Mbanguka who provided invaluable advice throughout the data collection stage.
...
The Lake Tanganyika baseline survey highlights critical aspects of household livelihoods, water and sanitation, governance, and fisheries management across 21 villages in the region. The study reveals that households are predominantly agriculture (44%) and fishing (27%) dependent. Poverty is widespread, with 64% living below the national upper poverty line. Household demographics show a young population, with 45.5% under 15 years, and a notable 22% of households headed by women, many of whom are widowed or divorced.

Water access and sanitation remain pressing challenges. In the dry season, only 37% of households rely on improved water sources, increasing to 76% during the wet season. Basic sanitation is prevalent, with 57% using open pit latrines and limited access to handwashing facilities (25%). These deficits pose significant health risks and highlight the need for infrastructure improvements.

Fisheries are vital to livelihoods but face sustainability challenges. Illegal fishing practices, declining fish stocks, and inadequate enforcement of regulations strain the sector. While awareness of fish reserves is high (81%) and there is support for their conservation role, over two-thirds of fishers report reduced catches in the past five years. Governance initiatives like Beach Management Units (BMUs) have seen stronger participation in northern villages, but southern regions lag behind.

The findings underscore the need for targeted support to enhance resource management, improve water and sanitation infrastructure, and support sustainable livelihoods. Strengthening governance structures, providing financial and technical support, and fostering economic diversification are critical to addressing these challenges and promoting long-term community resilience.
...
•	Population & Demographics:
  o	45.5% of the population is under 15 years; 52.2% is aged 15-64.
  o	Average household size: 5.2 (higher than the national average of 4.5 but lower than the 2011 Tuungane survey at 6.7).
  o	Female-headed households: 22% (widowed: 45%, divorced/separated: 32%).
•	Poverty Levels:
  o	64% live below the national upper poverty line; 26% below the extreme poverty line.

Livelihoods

•	Agriculture is the primary activity (44%), followed by fishing (27%).
•	In the northern villages, 41% engage in fish-related activities; in the south, 23% fish, and 17% process or trade fish.
•	Village-specific disparities highlight limited economic diversification.

Water & Sanitation

•	In the dry season, 37% use improved water sources; this increases to 76% in the wet season.
•	55% boil water as a treatment method; few use advanced filters.
•	Sanitation access is limited, with 57% using open pit latrines and only 25% having handwashing facilities.

Governance

•	41% of households believe they influence local government decisions, up from 24% in 2011.
•	Awareness of Beach Management Units (BMUs) is higher in northern villages (83%), with active participation by 34%.

Livelihood Practices of Fishers, Fish traders, and Fish Processors

•	Fishers report significant challenges:
  o	68% state decreased fish catches over five years.
  o	Ring nets are the most common fishing gear, though illegal practices persist.
•	Awareness of fish reserves is high (81%), with support for their role in boosting fish stocks.
...
and its environs confront various challenges endangering this delicate balance. Changes in fishing practices, changing local socio-economic and demographic conditions, deforestation, waste mismanagement, and limited access to services threaten the ecosystem and community well-being. The Nature Conservancy (TNC) initiated the Lake Tanganyika Program (LTP) by building from experience with other fishing communities along the Tanzanian lakeshore and acknowledging the pressing need to tackle these challenges while envisioning a harmonious coexistence between communities and nature. Through collaboration and innovative approaches, LTP aims to establish and support a regional network of community-based co-managed fisheries areas and empower communities to locally co-manage their fisheries, enhance fish value chains, improve livelihoods, and support conservation efforts.
Measuring the programme's impact over time is crucial to ensure its effectiveness and
sustainability. As such, this survey aims to deliver a household socioeconomic baseline assessment, which requires an understanding of local contexts, the capacity to identify challenges, and the ability to devise strategies for lasting development.

2. Purpose of the Survey

The main objective of the survey was to set a baseline to measure the impact brought about by the Lake
...
The survey covered the following wards: Kirando, Itete, Kipili, Mkinga Ward, Kala, and
Wampembe wards (kata), in the following 21 villages (vijiji): Kichangani,
...
Lyapinda, Kizumbi, Katenge, Ng'anga. For the purposes of this study, the 21 villages were disaggregated into a two clusters based on their geographic location. The northern cluster, generally referred to as "overall north", comprises villages centered around Kipili, including Kichangani, Mtakuja, Mkinga, Majengo Mapya, Manda Uhuru, Kalungu, Ntanganyika, Isasa, and Manda Kerenge. The southern cluster, "overall south", contains the villages of Kala, Mpasa, Kilambo ch Mikolechi, Tundu, Wampembe, Mwinza, Izinga, Kizumbi, Lyapinda, Ng'anga, and Katenge.  
...
data_formatted <- data %>%
  mutate(across(
    c(Population, Sample, `Final Sample Number`),  # Columns to round
    ~ round(.)  # Round to whole numbers
  )) %>%
  rename(
    `Proportion of Population and Sample` = `Proportion of Population`
  )
  
data_formatted <- data_formatted %>% select(-Sample, -`Proportion of Sample`)

# Create and style flextable
add_lot_link(caption = 'Northern village cluster sampling design for households along Lake Tanganyika')
...
data_formatted %>%
  ...
  colformat_double(
    ...
    digits = 3  # Default precision for other columns
  ) %>%
  colformat_double(
    j = c("Population", "Final Sample Number"),  # Specific columns to format as integers
    digits = 0
  ) %>%
...
```{r}
# Data
data <- readRDS("southern_cluster_sample_design.rds")
...
# Create and style flextable
add_lot_link(caption = 'Southern village cluster sampling design for households along Lake Tanganyika')
...
In this report, results presented in the figures are predominantly disaggregated by villages, clustered into those centred around Kipili in the north and those located to the south along the Lake Tanzania shoreline. We provide overall percentages for each cluster individually, Overall North and Overall South respectively. Where specific village findings are less relevant, we broadly provide the overall percentages across villages in each of the two clusters.
...
ggplot(demo_summary, aes(x = age_group, y = ifelse(sex == "MALE", -percentage, percentage), fill = sex)) +
  ...
  scale_fill_manual(values = SEA_palette_2,labels = c("FEMALE" = "Female", "MALE" = "Male")) +
  sea::theme_sea()+
...
Only 17% of female household heads are married, compared to 78% for all heads. The majority of female household heads are either widowed (45%) or divorced or separated (32%) (Table 5).
...
Overall, 30% of the household heads were born in the village where they lived at the time of the survey (Table 6). Kala and Mwinza stand out as less than 15% of resident household heads were born in those two villages. On average, household heads spent 22 years living in their village if they weren’t born there. This suggests that there has not been a high level of recent migration to the villages sampled in recent years.
...
Overall, 64% of households in the surveyed villages live below the upper national poverty line. 26% of households live below the extreme poverty line (Table 7). 
...
The majority of households indicated that they either have just enough or have difficulty meeting their daily needs (83%; Figure 4). Approximately 5% of households were able to save extra. Even though there are some differences, this general picture roughly applies to all villages.

```{r,  fig.cap='Self-assessment of the ability to meet daily needs at village level', fig.align='center', out.width = '95%'}
...
Almost half of households are engaged in agriculture and/or livestock keeping in the northern village cluster (47%), compared to 42% in the southern villages (Figure 5), which is markedly less than the 97% indicated by the 2011 Tuungane survey. Agriculture was the main livelihood activity in all villages except for Manda Kerenge, in which fishing was the most frequent activity. Overall, 41% of households are engaged in fish-based livelihood activities in northern villages, including fishing (30%), fish trading (7%), and fish processing (4%). In southern villages, 23% of households indicated that fishing was their main livelihood activity, 10% were involved in fish trading, and 7% in fish processing. A further 9% and 10% of household respondents were engaged in business activities in the northern and southern village clusters respectively. 
...
ggplot(livelihood_data_combined, aes(x = reorder(livelihood_activities, -proportion), 
  ...
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = SEA_palette_3) +
  sea::theme_sea() + 
  ...
  scale_x_discrete(labels = c("Agriculture", "Fishing", "Business", "Fish Trading", "Fish Processing", "Other", 
                              "Livestock Keeping", "Day Labour", "Tailor", "Employee", "Boat Builder", "Remittances", "Pensions")) +
...
Access to safe drinking water may depend on several variables including the source of the water and the ability to purify it. In this survey, we asked about the main water sources accessed by households and responses were split between dry and rainy seasons, as water sources can change depending on the season. Water sources were categorized as improved or unimproved sources following WHO and UNICEF standards (NBS & ICF Macro, 2011). Improved sources include public taps, protected private or public wells, and rainwater. Unimproved sources include open wells and surface water.

In the dry season, 62% percent of the households in the southern village cluster use an unimproved source, mainly surface water (i.e. rivers, streams, ponds, lakes), while in the wet season the use of rainwater reduces this to 22% (Figure 6). Respectively, in villages of the northern cluster, 47% of household use unimproved water sources in the dry season, compared to 20% in the wet season. Overall, 76% of households across the study area use an improved water source in the wet season, as opposed to 37% in the dry season (Table 8). 

Rainwater is exclusively used as a water source in the rainy season. Use of lake water is more common in the dry season when there are fewer alternatives. The most common improved source is a protected public tap followed by protected public wells.

```{r,  fig.cap='Main source of water', fig.align='center', out.width = '90%'}
# Combine data for wet and dry seasons
# Separate data by clusters for Dry Season
village_data_dry_cluster_1 <- tanganyika_survey %>%
  filter(village %in% cluster_1_villages) %>%
  ...
  mutate(Season = "Dry", WaterSource = drinking_water_dry, Cluster = "Overall North")

village_data_dry_cluster_2 <- tanganyika_survey %>%
  filter(village %in% cluster_2_villages) %>%
  group_by(drinking_water_dry) %>%
  summarise(
    proportion = survey_mean(vartype = "ci", na.rm = TRUE),
  ...
  mutate(Season = "Dry", WaterSource = drinking_water_dry, Cluster = "Overall South")

# Separate data by clusters for Wet Season
village_data_wet_cluster_1 <- tanganyika_survey %>%
  filter(village %in% cluster_1_villages) %>%
  ...
  mutate(Season = "Wet", WaterSource = drinking_water_wet, Cluster = "Overall North")

village_data_wet_cluster_2 <- tanganyika_survey %>%
  filter(village %in% cluster_2_villages) %>%
  group_by(drinking_water_wet) %>%
  summarise(
    proportion = survey_mean(vartype = "ci", na.rm = TRUE),
  ...
  mutate(Season = "Wet", WaterSource = drinking_water_wet, Cluster = "Overall South")

# Combine dataframes
village_data_combined <- bind_rows(
  village_data_dry_cluster_1,
  village_data_dry_cluster_2,
  village_data_wet_cluster_1,
  village_data_wet_cluster_2
)

# Create grouped bar chart with two rows for clusters
ggplot(village_data_combined, aes(x = reorder(WaterSource, -proportion), y = proportion * 100, fill = Season)) +
  ...
  scale_fill_manual(values = SEA_palette_2) +
  labs(x = "", y = "", fill = "") +
  theme_minimal() +
  ...
  facet_wrap(~ Cluster, nrow = 2)  # Separate rows for Cluster 1 and Cluster 2
```
...
relative_proportions <- village_data_combined %>%
  ...
  group_by(Season) %>%  # Normalize within each Season
  mutate(
    relative_proportion = total_proportion / sum(total_proportion, na.rm = TRUE),
    percentage = round(relative_proportion * 100)
  ) %>%
  ungroup() %>%
...
season_proportions <- relative_proportions %>%
  select(Season, SourceType, percentage) %>%
  pivot_wider(names_from = SourceType, values_from = percentage, values_fill = 0) %>%
  rename(
    `Improved Source (%)` = "Improved",
    `Unimproved Source (%)` = "Unimproved")

add_lot_link(caption = 'Water sources during dry and wet seasons')
...
In the dry season, the majority of households use an appropriate water treatment method by boiling water prior to use (Figure 7). Overall, boiling accounts for 55% of water treatment methods in both the northern and southern village clusters. A further 17% add bleach or chlorine in the southern village cluster, whereas only 8% do so in northern villages. Ineffective methods include straining water through a cloth prior to drinking, which is practiced by 36% and 27% of households respectively in northern and southern villages. In wet season, the proportion of households boiling water or adding bleach or chlorine prior to use drops to 44% and 5% in northern villages and 42% and 12% in southern villages respectively. This may likely be attributed to rainwater being the predominant water source during the wet season. Overall, very few households use a water filter (Figure 8).

A large amount of variation exists between the villages, ranging from fewer than a quarter to 80% of respondents using appropriate treatment methods. The addition of bleach or chlorine to water prior to use was highest in Isasa in dry season.
...
# Rename columns for clarity
colnames(toilet_table) <- c("Village", "Flush to Elsewhere", "Flush to Pit Latrine", "No Facility", "Pit with Slab", "Pit without Slab", "Composting Toilet", "Ventilated Improved Pit (VIP) Latrine")
...
toilet_table <- toilet_table %>%
  mutate(across(c("Flush to Elsewhere", "Flush to Pit Latrine", "No Facility", "Pit with Slab", "Pit without Slab", "Composting Toilet", "Ventilated Improved Pit (VIP) Latrine"),
...
total_row <- tanganyika_survey %>%
  summarise(
    ...
    `Pit with Slab` = survey_mean(toilet_facilities == "PIT LATRINE WITH SLAB", na.rm = TRUE) * 100,
    `Pit without Slab` = survey_mean(toilet_facilities == "PIT LATRINE WITHOUT SLAB/OPEN PIT", na.rm = TRUE) * 100,
  ...
  mutate(
    ...
    `Pit with Slab` = paste0(round(`Pit with Slab`, 0)),
    `Pit without Slab` = paste0(round(`Pit without Slab`, 0)),
...
Overall, only 25% of households had handwashing facilities available (Table 10). Households in Kalungu, Mtakuja, and Isasa contained the highest proportion of handwashing facilities. Where handwashing facilities were available, 53% of households indicated there was water and 39% had soap available. Tippy taps were encountered across 8% of all households.
...
Beds and mattresses are most commonly owned of the listed household goods (19% north and 23% south; Figure 9). Thereafter, mobile phones are owned by 19% of households in southern villages and 16% of villages in the northern cluster, respectively, a further 3% and 6% of respondents in the southern and northern villages clusters indicated owning a smartphone. This is significantly lower than the national average of 83% of households that own a mobile phone (2022 TDHSMIS). Radio ownership across the survey population (11%) was also significantly lower than both the 2011 Tuungane survey (75%) and the 2022 national average (44%; 2022 TDHSMIS). Solar panel ownership appears higher in the southern village cluster (20%) in comparison to the northern village cluster (13%).
...
ggplot(household_item_data_combined, aes(x = reorder(household_item, -proportion), y = proportion * 100, fill = reorder(household_item, -proportion))) + 
  ...
  scale_y_continuous(labels = label_percent(scale = 1)) +
  scale_x_discrete(labels = c("Mattress", "Mobile Phone", "Solar Panel", "Table", "Radio", "TV", "Smartphone", "TANESCO Power", "Iron", "Sofa", "Refrigerator", "Clock", "Generator")) +
  facet_wrap(~ cluster, nrow = 2)  # Separate plots for each cluster
...
Only 1% of households indicated having access to clean cooking fuel, namely gas. The vast majority of the survey population use solid fuels such as charcoal (67% north; 42% south) and firewood (30% north; 57% south) (Figure 10). This is comparable to the national average, in which 93% of Tanzanian households make use of solid fuels including charcoal and firewood (2022 TDHSMIS). Interestingly, among the southern cluster of villages, with the exception of Wampembe, households appear to use firewood as the primary cooking fuel. In contrast, the majority of villages in the northern cluster make use of charcoal. Gas was only used as a cooking fuel amongst eight villages, of which Kipili indicated the highest use (9%). 
...
# Rename columns for clarity
colnames(proportion_table) <- c("Village", "Used almost everyday", "Used at least once a week", "Used less than once a week")

# Format the proportion table values as percentages with one decimal point and add % sign, leave NA as blank
proportion_table <- proportion_table %>%
  mutate(across(c("Used almost everyday", "Used at least once a week", "Used less than once a week"),
                ~ ifelse(is.na(.), "", paste0(round(. * 100, 0)))))

combined_table <- efficient_stove_table %>%
  select(Village, `Efficient Stove Ownership` = Yes) %>%
  left_join(proportion_table %>% select(Village, `Used almost everyday`, `Used at least once a week`, `Used less than once a week`), by = "Village") 
...
total_row_use <- design %>%
  summarise(
    Village = "Overall",
    `Used almost everyday` = survey_mean(efficient_stove_use == "ALMOST EVERY DAY", na.rm = TRUE) * 100,
    `Used at least once a week` = survey_mean(efficient_stove_use == "AT LEAST ONCE A WEEK", na.rm = TRUE) * 100,
    `Used less than once a week` = survey_mean(efficient_stove_use == "LESS THAN ONCE A WEEK", na.rm = TRUE) * 100) %>%
  mutate(
    `Used almost everyday` = paste0(round(`Used almost everyday`, 0)),
    `Used at least once a week` = paste0(round(`Used at least once a week`, 0)),
    `Used less than once a week` = paste0(round(`Used less than once a week`, 0))) %>%
  # Remove columns with "_se" in their names
  select(-contains("_se"))

total_row <- left_join(total_row_stove, total_row_use, by = "Village") %>%
  select(Village, `Efficient Stove Ownership`, `Used almost everyday`, `Used at least once a week`, `Used less than once a week`)

# Add the "Total" row to the combined table
combined_table <- bind_rows(combined_table, total_row)
colnames(combined_table) <- c("Village", "Efficient Stove Ownership (%)", "Used almost everyday", "Used at least once a week", "Used less than once a week")
...
Overall, approximately 18% of households had borrowed money at least once in the previous year (Figure 11). The proportion of households that took out credit is highest in Kichangani and Wampembe and lowest in Ng’anga and Tundu.
...
village_data_yes <- village_data_yes %>%
  mutate(
    village = factor(
      village,
      levels = c(
        cluster_2_order,  # Use the specified order for Cluster 1
        setdiff(unique(village_data_yes$village[village_data_yes$cluster == "Cluster 1"]), "Overall North"),
        "Overall North")))
...
Business expenses (29% north; 17% south) and farming expenses (22% north; 21% south) were the most common reasons for taking out a loan (Figure 12). In the southern village cluster, other common reasons for taking out a loan included covering household expenses (19%), food (20%), and medical expenses (15%). In the northern village cluster, it was slightly less common to take a loan out for household expenses (15%) and food (12%), whereas loans taken out for medical expenses (17%) were comparable to the northern villages cluster.
...
Half the borrowing households in the southern village cluster receive their loans from friends or neighbours and roughly a quarter of loans were given by family, compared to 38% from friends or neighbours and 20% from family in the northern village cluster (Figure 13). Community Conservation Banks (COCOBA), Savings and Credit Societies (SACCO), Fisher Committee (FICO), and Village Community Banks (VICOBA) accounted for 6% of loans given. COCOBA, SACCOS, and VICOBA all provide savings and loan schemes to groups of villagers.

```{r, fig.cap='Source of loans', fig.align='center', out.width = '90%', fig.height=8}
...
The most common reason for not taking out a loan was the fear of being in debt, which was listed by 41% and 34% of respondents that didn’t borrow money in the past year in northern and southern village clusters respectively (Figure 14). A further 15% of respondents in northern villages and 20% in southern villages stated that they found the process of taking out a loan too difficult or had no need for doing so (approx. 16% in both clusters). 

```{r,  fig.cap='Reason for not having borrowed any money in the previous year', fig.align='center', out.width = '90%', fig.height=8}
village_data <- tanganyika_survey %>%
...
Overall, 14% of household respondents across all villages in the northern cluster stated that they were a member of a COCOBA, SACCO, or FICO. Membership was highest in Manda Uhuru (30%). Only two villages of the southern cluster contained households with COCOBA/SACCO/FICO members, namely Katenge and Wampembe. 
...
Roughly two thirds of households use mobile phones to make financial transactions across both village clusters (Figure 16). The frequency of mobile transactions is relatively high, notably so in Isasa (90%) and Mtakjua (82%), only in Ng’anga did less than half of the household make use a mobile phone to make transactions.
...
ggplot(fish_proportions_combined, aes(x = fish_type, y = proportion, fill = frequency)) +
  ...
  scale_fill_manual(values = SEA_palette,labels = c("LESS THAN ONCE A WEEK" = "Less than Weekly",
...
More than two thirds of the fish eaten in the past week stemmed from purchases in the northern village cluster (69%), whereas approximately a quarter was eaten from own catch (25%). In the southern village cluster, 56% of fish eaten stemmed from purchases and 35% from own catch (Figure 18). 
...
Fish consumption has changed in the past five years (Figure 19). The majority of all households across both village clusters indicated that they eat less fish now. Approximately a fifth of households eat the same amounts of fish as five years ago, and approximately 12% of households in northern and southern villages stated that they eat more fish now. 
...
Food shortages occurred amongst 64% and 60% of all households in northern and southern village clusters respectively during the last 12 months (Figure 20). In all villages, half or more than half of households experienced at least one food shortage over the past 12 months. Shortages were most frequent in Manda Uhuru, where 95% of households were affected. 

```{r, fig.cap='Proportion of food shortages experienced during the last 12 months at village level (%)', fig.align='center', out.width = '90%', fig.height=7}
...
```{r, fig.cap='Changes in household food availability over the past 12 months', fig.align='center', out.width = '90%', fig.height=8}
village_data <- tanganyika_survey %>%
...
When viewed over the period of the last five years, the trend in food availability appears similar in the north and south (Figure 23). Overall, 15% of households in the northern village cluster and 18% in the southern village cluster experience better food availability, an estimated 54% experience the same availability of food, and 32% and 26% of households in northern and southern village clusters express being worse off now.  

```{r, fig.cap='Change in household food availability over the last 5 years', fig.align='center', out.width = '90%', fig.height=8}
village_data <- tanganyika_survey %>%
...
```{r,  fig.cap='Reasons for increase in household food availability', fig.align='center', out.width = '90%', fig.height=9, fig.width=10}
...
The reasons for an increase in food availability vary (Figure 24). Roughly 33% of respondents attributed their increase in food availability to improvements in fish stocks. Reasons also pertained to agriculture, as 25% of respondents in the northern cluster and 33% in the southern cluster attributed the improvements to food availability to thriving crop harvests, whereas 19% of respondents across both clusters linked it to the use of fertilizer applied to their fields. Interestingly, a small subset of respondents linked their improvement in food availability to decreases in fish availability or destroyed crops, this may perhaps be related to a diversification in income or simply a misunderstanding.

In response to being asked why food availability might be better now due to other reasosn, household respondents mentioned a variety of reasons. Diversification of income sources was stated as another reason as to why food availability had improved over the past year (n = 4). Households expressed that previously, their income was solely dependent on fishing, but now they have diversified their sources of income, such as (poultry) farming, improving their financial situation. Improved farming practices (n = 3), increases in agricultural productivity due to expanding land under cultivation (n = 2), improvements in business activities (n = 2), stabilized food prices  (n = 1), and improvements in personal life (n = 1) and financial support obtained (n = 1) include other reasons for which food availability has improved.

> ninajishughulisha na shughuli mbalimbali ukitoa uvuvi

```{r,  fig.cap='Reasons for decrease in household food availability', fig.align='center', out.width = '90%', fig.height=9, fig.width=10}
# Expand the data and add cluster information
availability_reason_expanded <- tanganyika_clean %>% 
  select(hh_code, village, availability_reason, availability_changed, stype, fpc) %>%
  separate_rows(availability_reason, sep = "\\|") %>%
...
Overall, almost half of the households (41%) think that they can influence village government decisions (Table 13). This is significantly more than the 24% estimated by the 2011 Tuungane survey and signifies an improvement in local governance and participation. Looking at the village level, three quarters of respondents in Majengo Mapya felt they could not influence government decisions.  
...
Trust is vital in establishing relationships between different stakeholders and can be an apt indicator of good relations in local governance. Trust between local villagers and local government authorities was high, as 63% and 74% of respondents in northern and southern village clusters respectively indicated that local government authorities could be trusted always or most of the time. However, people expressed having less trust in people from neighbouring villages or even people from their own village. Approximately 40% of respondents across both clusters indicated that people from neighbouring villages could rarely be trusted or never be trusted, this corresponded to 32% and 29% with regards to people in their own village for villages in the northern and southern cluster respectively.
...
ggplot(trust_proportions, aes(x = party, y = proportion, fill = fct_relevel(trust, "CAN ALWAYS BE TRUSTED", "CAN MOSTLY BE TRUSTED", "NEUTRAL", "CAN RARELY BE TRUSTED", "CAN NEVER BE TRUSTED"))) +
  ...
  scale_fill_manual(values = SEA_palette,labels = c("CAN ALWAYS BE TRUSTED" = "Always Trusted",
...
Overall, attendance of public meetings to discuss topics such as village land-use planning, lake management and/or fisheries management was estimated at 41% (Table 14). This reflects the trend observed in Table 13 about household influence on village government decisions. Similarly, three quarters of respondents from Majengo Mapya did not attend any public meetings in the past year. This corroboration of findings across different questions for this village suggests that there are issues in participation.
...
Conflicts and/or disputes about fishing occur rarely, with three quarters of all household respondents in the southern cluster and 56% in the northern cluster stating that conflicts occur rarely or never (Figure 28). In total, 14% of respondents indicated that conflicts occur often in the southern cluster. Conflicts appear to happen more frequently in the northern village cluster, as 24% indicated conflicts occur often. Conflicts occur most often in Manda Kerenge (32%), Manda Uhuru (30%), and Mtakuja (29%). Positively, in the past year, the frequency of conflicts has decreased in most villages (Figure 29). Only in Katenge are there more conflicts than there were 12 months ago, as was indicated by 60% of respondents from the village. 
...
ggplot(conflict_data, aes(x = village, y = proportion * 100, group = fct_relevel(disputes_conflicts, "OFTEN", "RARELY", "NEVER", "NOT SURE"), fill = fct_relevel(disputes_conflicts, "OFTEN", "RARELY", "NEVER", "NOT SURE"))) +
  ...
  guides(fill = guide_legend(title = NULL)) +
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = SEA_palette, labels = c("OFTEN" = "Often",
                                          "RARELY" = "Rarely",
                                          "NEVER" = "Never",
                                          "NOT SURE" = "Not Sure")) +
  sea::theme_sea() + 
...
ggplot(conflict_data, aes(x = village, y = proportion * 100, group = fct_relevel(more_less, "MORE", "SAME", "LESS", "NOT SURE"), fill = fct_relevel(more_less, "MORE", "SAME", "LESS", "NOT SURE"))) +
  ...
  guides(fill = guide_legend(title = NULL)) +
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = SEA_palette, labels = c("MORE" = "More",
                                          "SAME" = "Same",
                                          "LESS" = "Less",
                                          "NOT SURE" = "Not Sure")) +
  sea::theme_sea() + 
...
Approximately a quarter of all reasons for conflicts in the northern village cluster concern the closure of the lake to fishers or the conflicts surrounding the use of illegal fishing gear (Figure 30). In southern villages, 38% of households attributed conflicts to concern closure of the lake and 34% indicated conflicts to be about the use of illegal fishing gear. Fishing in protected breeding areas and the catching of undersized fish also contributed to conflicts, these reasons appeared higher in the northern village cluster as opposed to the south. 

Respondents were asked about other reasons that conflicts and/or disputes were about. Other conflict reasons described relate to permit and licensing challenges (n = 8), as some fishers appear to struggle with the high costs and complicated requirements for obtaining fishing licenses, including having to pay for multiple licenses for both the fisher and the boat. Furthermore, conflict may occur around instances of corruption and/or bribery of BMU officers (n = 2), arguments on the market surrounding fish pricing (n = 2), theft and security issues (n = 2).

> Migogoro kati ya wavuvi na maafisa uvuvi kuhusu leseni za uvuvi, wavuvi wengi kukataa kutozwa leseni > mara mbili (leseni ya mvuvi na leseni ya mtumbwi

```{r,  fig.cap='Reasons for conflict', fig.align='center', out.width = '90%', fig.height=7}
...
The majority of conflicts are resolved in a fair manner (Figure 32). Once again, Katenge stands out as a vast majority of respondents do not believe that conflicts are resolved fairly (80%). Unfair conflict resolution also appears high in Izinga and Wampembe. In general, it appears that in the northern cluster of villages fair conflict resolution is higher than in the southern cluster. 

In response to the question “Among whom do these disputes or conflicts mostly occur?”, respondents listed a few other options. Other parties listed among which disputes or conflicts occur include fishers and fisheries officers (n = 17) and include reasons such as conflict over illegal fishing, disagreements over payments and equipment provision, and conflicts regarding the lake closure. 

> Migogoro kati ya wavuvi na maafisa uvuvi,maafisa uvuvi kula pesa za wavuvi na hawaletewi zana za
> uvuvi kama makubaliano

Fishers also experience disputes with government (n = 10), including national government, Nkasi district government, and the government of Izinga village. Furthermore, bandits from Congo (n = 3) were also listed as a conflict party.

> Kati wa wavuvi na majambazi kutoka Congo
...
ggplot(conflict_data, aes(x = village, y = proportion * 100, group = fct_relevel(fair_resolution, "YES", "NO", "NOT SURE"), fill = fct_relevel(fair_resolution, "YES", "NO", "NOT SURE"))) +
  ...
  guides(fill = guide_legend(title = NULL)) +
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = SEA_palette, labels = c("YES" = "Yes",
                                          "NO" = "No",
                                          "NOT SURE" = "Not Sure")) +
  sea::theme_sea() + 
  theme(legend.position = "bottom",  legend.direction = "horizontal",  legend.justification = "center", 
...
Respondents were asked “If there is a dispute or conflict between BMUs and fishers, how do people in your village try to solve it?”. In response, households indicated that conflicts may be solved in several ways. Two respondents indicated that disputes between BMUs and fishers are formally resolved by involving law enforcement authorities. This usually involves reporting the issue to the local police station for investigation and resolution. One respondent highlighted the role of community gatherings in resolving conflicts. These gatherings provide a platform for fishers and BMUs to engage in open discussions and come to a consensus on how to address the issue. Another respondent mentioned that some conflicts do not escalate to a level requiring intervention. These are perceived as minor issues that do not cause significant harm and, as such, are often left unresolved.

Respondents were asked about who they thought to be an influential leader among their community, for instance a local leader whom they respect and who they think is good at raising awareness in their village about important communal issues (Figure 33). In response, political leaders and religious leaders were mentioned most commonly. Political party leaders, civil servants, and respected elders were also mentioned frequently across both clusters. Of these influential leaders, more than 70% across both village clusters already occupied a village, ward, or regional government position (Figure 34). 

```{r,  fig.cap='Influential community leaders', fig.align='center', out.width = '95%', fig.height=9, fig.width=9}
...
```{r, fig.cap='Are Influential leaders currently involved in a village, ward, or regional government position?', fig.align='center', out.width = '90%', fig.height=9}
village_data <- tanganyika_survey %>%
...
By establishing Beach Management Units (BMUs), villages are able to enact and enforce their own sustainable fishing regulations and protect fish breeding and nurseries zones. Awareness of BMUs was strikingly low in the southern villages, only a few households in Izinga, Mwinza, and Ng’anga had heard of BMUs (Figure 35). On the contrary, the majority of households in the northern village cluster had an awareness of BMUs in their village, overall this accounted for 83% household awareness of BMUs.
...
Overall, BMU membership in the northern village cluster is estimated at 31% of households (Figure 37). Household membership appears highest in Mtakuja (45%) and lowest in Majengo Mapya (17%). Despite 3% of households indicating that they are members of a BMU in Mwinza, it appears that across the whole southern village cluster no BMUs have been established to date. 
...
Three quarters of all households in the northern cluster believed that their BMU had good leaders in place (Figure 40). In most instances (85%), respondents indicated that election procedures to choose BMU leaders were fair (Figure 41). Only 8% believed that BMU leaders were elected unfairly. Furthermore, two thirds of people indicated that there is good trust and collaboration between their BMU and government authorities in the management of fishing resources (Figure 42). Please note that the large confidence intervals observed in the southern cluster of Figures 40, 41, and 42 can be attributed to the very low sampling size of respondents that had an awareness of BMUs (n = 4).

```{r, fig.cap='Do you think the BMU has good leaders?', fig.align='center', out.width = '90%', fig.height=9}
...
```{r, fig.cap='Were BMU leaders elected or chosen fairly?', fig.align='center', out.width = '90%', fig.height=9}
# Expand the data with cluster classification
...
```{r, fig.cap='Indication of trust and collaboration between BMU and the Government in the management of fishing resources', fig.align='center', out.width = '90%', fig.height=9}
# Expand the data with cluster classification
...
Where BMUs are established, in the northern cluster of villages, almost two thirds of BMUs have written bylaws in place, which is an indication for good governance and fisheries management (Figure 43). At village level, approximately half or more of respondents in each village indicated that written bylaws were in place in their BMU. 
...
In response to the statement “BMU bylaws are being followed”, the majority of households responded in agreement (85%). Only 13% of households either disagreed or strongly disagreed to the statement (Figure 44). 
...
When asked whether BMUs have improved fishing practices, 44% of households in the northern cluster responded in agreement and a further 23% of households strongly agreed (Figure 45). Few people felt neutral about the impact of BMUs on fishing practices, but 28% of respondents either disagreed or disagreed strongly. In the southern cluster, two out of three respondents that knew about BMUs agreed that they indeed improved fishing practices. Please note the large confidence intervals in this cluster are due to low sampling size. 

```{r, fig.cap='Do you think the BMU has improved fishing practices?', fig.align='center', out.width = '90%', fig.height=9}
...
> Ipewe vitendea kazi bora ili kuongeza ufanisi wao
...
## Livelihood Practices of Fishers

Overall, in both the northern and southern clusters of villages, canoes without engine are the most frequently used type of fishing boat (Figure 46). Only in Majengo Mapya and Ntanganyika are engine boats more frequently used than canoes without engine. In Izinga, fishers indicated using using large boats with an engine most frequently. Across village clusters, large boats with engine appear more frequently used in the northern villages.
...
As part of an exercise in the fisheries sub-section of the question, respondent were asked to rank six fish species based on their importance. Migebuka, a perch-like fish, and dagaa , a type of freshwater sardine, represent the most important fish in the region (18% respectively). Other species of near-shore fish, such as kungura and ngege, were also perceived as important. Overall, there appeared little variation in the perceived importance of fish species across the northern and southern clusters of villages (Figure 47).
...
# Add a "Total" group for Cluster 1 and Cluster 2 separately
total_data_cluster_1 <- strat_design %>%
  filter(cluster == "Cluster 1") %>%
...
total_data_cluster_2 <- strat_design %>%
  filter(cluster == "Cluster 2") %>%
  group_by(Fish_Species) %>%
  summarise(
    mean_importance = survey_mean(Importance, vartype = "ci", na.rm = TRUE),
...
# Combine the total_data for both clusters
aggregate_fish_importance <- bind_rows(total_data_cluster_1, total_data_cluster_2)

aggregate_fish_importance <- aggregate_fish_importance %>%
  mutate(cluster = case_when(
    cluster == "Overall South" ~ "Cluster 2", TRUE ~ cluster))

aggregate_fish_importance <- aggregate_fish_importance %>%
  mutate(village = reorder(village, -mean_importance_percent))  # Reorder villages based on proportion

# Reorder Fish_Species based on average proportion for each species
...
Fishers were asked to provide a self-assessment of fisheries resource management over the past five years (Figure 48). Across both village clusters, half of the respondents indicated that they had participated in good fisheries management practices (north 49%; south 52%). Respectively, in the northern and southern village clusters, 34% and 37% indicated that fisheries management had been bad or very bad over the past five years. Overall, 58% of fishers believed that their rights to access and use resources of the fishery are being upheld by regulatory and/or communal systems (Table 17). Additionally, 62% of fishers expressed that they were happy with the current security of their rights over fisheries resources. However, only 24% indicated that they were involved in decision-making processes regarding resource management of their fishery. Of the fishers involved in decision-making processes concerning the fisheries resource, the vast majority of fishers in both the northern and southern clusters of villages stated they were happy with their level of involvement (Figure 49).

```{r, fig.cap='Self-assessment of fisheries resource management over the past five years', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
...
```{r, fig.cap='Satisfaction with involvement in decision-making around fisheries resources?', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
...
Furthermore, fishers were asked to provide an indication of their relationship with fisheries extension officers. In the southern village cluster, 63% of respondents stated they had a good relationship, 20% described their relationship with fisheries extension officers as average, and a further 17% stated they maintained a bad relationship (Figure 50). Similarly, 65% of respondents in the northern village cluster indicated their relationship with fisheries extension officers to be good, while 18% described it as average, and 16% as bad. 

```{r, fig.cap='An indication of the relationship with fisheries extension officers', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
...
> Kutokushirikishwa ipasavyo na maafisa uvuvi ivyo hupelekea kua na uhusiano mbaya kati ya wavuvi na  > maafisa uvuvi

> Kama sina leseni ya uvuvi na mtumbwi hauna leseni siwezi kuruhusiwa kuvua

Awareness of fish reserves was uniformly high amongst fishers (81%; Table 18). Furthermore, 84% of respondents were aware of the purpose of fish reserves and 88% indicated that they thought the implementation of fish reserves to be a good idea. Awareness of fish reserves and their respective purpose was lowest in Ng’anga, however this may at least in part be attributed to the low sampling size of fishers in the village (n = 5). 
...
Half of fishers in the northern and southern village clusters indicated that they believed current fish stocks to be sufficient in meeting the fishing, food, and livelihood needs of their community (Figure 51). Respectively, a further 44% and 39% of fishers in the northern and southern village clusters did not believe this to be true.

```{r, fig.cap='At the moment, do you think the current number of fish in the lake is sufficient to meet the fishing, food, and livelihood needs of the community?', fig.align='center', out.width = '90%', fig.height=8}
...
In terms of the sustainability of current fishing practices on fish stocks, almost two thirds of fishers in northern villages believed there to be sufficient fish for communities in future (Figure 52). In contrast, merely half of the fishers in southern villages believed this statement to be true. Furthermore, 37% of fishers in the southern villages did not believe there would be enough fish whilst 16% weren’t sure. In northern villages, 30% of fishers did not think there will be sufficient fish for the communities in future. 
...
ggplot(fishing_gear_data, aes(x = village, y = proportion * 100, group = fishing_gear, fill = fishing_gear)) +
  ...
  guides(fill = guide_legend(title = NULL, nrow = 2, reverse = FALSE)) +
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = SEA_palette_3, labels = function(labels) str_to_title(str_to_lower(labels))) +
  sea::theme_sea() + 
  theme(legend.position = "bottom",  legend.direction = "horizontal",  legend.justification = "center", 
    # axis.text.y = element_blank(),  # Remove y-axis labels
    # axis.ticks.y = element_blank(),  # Remove y-axis ticks
...
Fish may be targeted seasonally. However, all fish species that were surveyed appear to be targeted throughout the year by at least 40% of all fishers (Figure 54). Dagaa represents the only fish species that is more commonly targeted in the dry season than in the wet season for both northern and southern village clusters.
...
ggplot(aggregate_target_type_combined, aes(x = Fish_Species, y = mean_season_percent, group = Season, fill = Season)) +
  ...
  labs(x = NULL, y = NULL) +
  guides(fill = guide_legend(title = NULL)) + 
  scale_fill_manual(values = SEA_palette,labels = function(labels) str_to_title(str_to_lower(labels))) +
  sea::theme_sea() + 
...
The majority of fishers require less than six hours to access their fishing grounds (69%; Table 19). The average time required to access fishing grounds is estimated at 02:44:00. Fishers in Kala require the longest time to access their fishing grounds, just short of four hours. On the contrary, fishers from Manda Uhuru are the fastest to reach their fishing grounds at under two hours. 
...
overall_row <- tanganyika_time %>%
  summarise(
    ...
    `Less than 10 hrs (%)` = paste0(round(mean(time_category == "<10 hours") * 100, 0)),
    `More than 10 hrs (%)` = paste0(round(mean(time_category == ">10 hours") * 100, 0)),
    `Mean time (hrs)` = sprintf("%02d:%02d:%02d",
                                    as.integer(mean(time_hours)),
                                    as.integer((mean(time_hours) %% 1) * 60),
                                    round(((mean(time_hours) %% 1) * 60 %% 1) * 60)))

summary_table <- bind_rows(summary_table, overall_row)
...
Forty percent of fishermen state that there is no change in the time required to access their fishing ground when compared to five years ago (Table 20). Three out of ten fishermen stated that it takes them longer to reach their fishing grounds, while another three out of ten indicate to be faster nowadays compared to five years ago. Average catches have changed in the last five years. More than two thirds of fishers stated that their catch size has decreased. Only 13% of fishers have increased their catch sizes in comparison to five years ago.
...
add_lot_link(caption = 'Change in time required to access fishing ground and change in average catch compared to five years ago')
...
> Kwa sababu kutokana na uhitaji mkubwa wa samaki na samaki ni wachache

Sale prices of fish appear to have fluctuated a lot in the past five years (Figure 55). Dagaa fetched the highest average sale price in northern villages at TSh 21,039. In southern villages, the highest sale price for Dagaa was TSh 17,868. Lowest sale prices for Dagaa were estimated at TSh 9,958 in northern villages and TSh 6,744 in southern villages. The highest sale price for Migebuka is estimated at TSh 14,570 in southern villages and TSh 13,587 in northern villages. Migebuka sale prices reached as low as TSh 7,187 in southern villages and TSh 9,236 in northern villages. Interestingly, the average lowest price of Sangara in northern villages appears higher than the average best price fetched for this species. However, there appears to be variation in the two prices, which may indicate a relatively stable price for Sangara over the past five years. This is corroborated by the limited variation observed in the price of Sangara in southern villages.
...
When asked to rate their satisfaction levels, fishers appeared to express neutrality or a low satisfaction on most aspects affecting their fishing practices (Figure 56). Fishers were most satisfied with their fishing skills, business skills, and access to markets, however this only amounted to a neutral score.
...
Three quarters of fishers in the northern village cluster believe that BMUs are helpful to improving fishing practices (Figure 58). There are no estimates for this statistic in the southern village cluster as BMUs do not appear to be established yet. As such, fishing group membership of cooperatives, FICOs, COCOBA or savings groups across villages of the southern cluster appears to be very limited (Table 21).  Where fishermen were members of a group, practically all stated that these were supported by TNC and many indicated the group to be helpful.
...
In response to the question “What are the top three key changes to improve the group?”, fishing group members indicated the need for increased financial support and resources, such as providing capital or loans, and creating group laws to facilitate access to loans (n = 10). They also mentioned that members themselves need to be more accountable in paying their membership shares on time, encouraging timely repayment. Furthermore, respondents shared the need for increased education and training, including education on illegal fishing, entrepreneurship, and loans. They emphasized the importance of seminars and meetings for better management of activities. Furthermore, group members reiterated the need to increase access to improved fishing equipment, group and governance structures.

Two thirds of fishers in the northern village cluster did not feel that their current activities are likely to support their needs over the long term (Figure 59). There was no data available to gauge this statistic in the southern village cluster.

```{r, fig.cap='Do you think your current activities are likely to support your needs over the long term (next 5-10 yrs)?', fig.align='center', out.width = '90%'}
# Expand the data with cluster classification
village_data_expanded <- tanganyika_survey %>%
...
Although there exist different forms of fish traders, the majority of respondents simply labelled themselves as a trader, whereas a remaining 8% and 9% considered themselves to be someone who prepares fish in northern and southern village clusters (Figure 60). 

```{r, fig.cap='Forms of fish trading', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
village_data_expanded <- tanganyika_survey %>%
...
To better understand the fish supply chain, fish traders were asked about where they buy their fish from. The majority of fish traders (n = 92) mentioned buying fish directly from fishers at the shore, then selling them fresh or after processing at local markets. Few traders stated that they purchase fish from different villages and coastal areas (n = 25), directly from processing facilities (n = 2), or from local middlemen (n = 2). The primary customer base of fish traders were wholesale buyers (n = 67). Respondents shared that they sell primarily to small and large-scale traders within the region, neighboring areas, and internationally, including markets in Zambia, Burundi, and Congo. Key markets include Namanyere, Sumbawanga, and Songwe, with customers ranging from local vendors to wholesalers and exporters.

Trading of fish species can be bound to seasonal changes in climate and/or lake conditions. However, over the past five years, the majority of fish traders indicated that trading activities of fish species such as Dagaa, Kuhe, Kungura, Migebuka, Ngege, and Sangara may occur during all seasons (Figure 61). With the exception of Dagaa, fish species in the southern village cluster are traded more frequently during the dry season. In southern villages, no Dagaa is traded in the rainy season. In contrary, across the northern village cluster, the majority of Dagaa is traded during the rainy season (42%). Likewise, rainy season trade is higher for all fish species across the northern villages in comparison to the southern cluster. Dry season trade of Kuhe (56%), Ngege (58%), and Sangara (59%) appears particularly high in the southern village cluster. 
...
# Ensure all combinations of Fish_Species, Season, and cluster exist
complete_data <- expand.grid(
  Fish_Species = unique(aggregate_target_type$Fish_Species),
  Season = unique(aggregate_target_type$Season),
  cluster = unique(aggregate_target_type$cluster))

# Merge with existing data to fill in missing combinations
aggregate_target_type <- complete_data %>%
  left_join(aggregate_target_type, by = c("Fish_Species", "Season", "cluster")) %>%
  mutate(
    mean_season = replace_na(mean_season, 0),
    mean_season_low = replace_na(mean_season_low, 0),
    mean_season_upp = replace_na(mean_season_upp, 0),
    mean_season_percent = replace_na(mean_season_percent, 0),
    mean_season_percent_low = replace_na(mean_season_percent_low, 0),
    mean_season_percent_upp = replace_na(mean_season_percent_upp, 0))

# Restrict confidence intervals between 0 and 100
aggregate_target_type <- aggregate_target_type %>%
  mutate(
    mean_season_percent_low = pmax(mean_season_percent_low, 0),
    mean_season_percent_upp = pmin(mean_season_percent_upp, 100))
...
ggplot(aggregate_target_type, aes(x = Fish_Species, y = mean_season_percent, group = Season, fill = Season)) +
  ...
  geom_errorbar(aes(ymin = mean_season_percent_low, ymax = mean_season_percent_upp),
                position = position_dodge(width = 0.95), width = 0.2) +
  geom_text(aes(
    y = ifelse(mean_season_percent_upp == 100, 100.5, mean_season_percent_upp + 2),  # Adjust labels for 100%
    label = ifelse(mean_season_percent > 0, scales::percent(mean_season_percent / 100, accuracy = 1), "")),
  position = position_dodge(width = 0.95), size = 3, vjust = 0) +
  labs(x = NULL, y = NULL) +
  guides(fill = guide_legend(title = NULL)) + 
  scale_fill_manual(values = SEA_palette, labels = function(labels) str_to_title(str_to_lower(labels))) +
  sea::theme_sea() + 
  theme(legend.position = "bottom", 
        ...
        legend.box = "horizontal") + 
  scale_y_continuous(labels = label_percent(scale = 1), limits = c(0, 105)) +  # Expand y-axis slightly above 100%
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) +
  facet_wrap(~ cluster, nrow = 2, labeller = labeller(cluster = c("Cluster 1" = "Overall North", "Cluster 2" = "Overall South")))
...
Sale prices of fish according to fish traders displayed notable variation. The highest sale prices are exhibited for dagaa and kungura in northern villages at TSh 18,904 and TSh 17,578 (Table 62). Respectively, the lowest price for dagaa is estimated at TSh 8,002 and TSh 9,700 for migebuka in northern villages. In the southern village cluster, the best price fetched for dagaa was TSh 15,988 and the lowest TSh 6,623. The highest price for kungura in the south was TSh 12,025 and TSh 6,261 at its lowest. Respectively, across the southern and northern cluster, the highest prices fetched for migebuka was TSh 14,617 and TSh 15,740. The lowest sale price for migebuka was TSh 8,153 and TSh 8,326 across southern and northern clusters respectively.
...
combined_target$Fish_Species <- gsub("_trade", "", combined_target$Fish_Species)
...
Satisfaction levels of fish traders reflected that of fishers. Fish traders were most satisfied about their skills and business skills (Figure 63). Fish traders appeared least satisfied with the support they receive from groups and/or organizations, this is especially true for villages in the southern cluster.
...
Three quarters of fish traders do not believe that their current trading activities are likely to support their needs over the long term (Figure 64). 

```{r, fig.cap='Do you think your current trading activities are likely to support your needs over the long term (next 5 - 10 years)?', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
village_data_expanded <- tanganyika_survey %>%
...
> Kipato ninachokipata haitoshelezi kulingana na mahitaji kuwa mengi
 
In response to the question “What unsustainable practices exist in your area when it comes to fish business activities?”, a variety of reasons were mentioned by households involved with the fish trade. Unsustainable practices in the fish trade include the use of illegal and harmful fishing gear such as poisoned nets and non-standard equipment, which contribute to overfishing and depletion of fish stocks (n = 23). The practices are thought to threaten long-term sustainability by disrupting fish reproduction. Poor resource management, including the destruction of fish habitats and improper handling of fish remains, further exacerbates the problem (n = 3). Over-exploitation, such as harvesting immature fish and dependency solely on lake fisheries, limits resilience to stock depletion (n = 10). These practices, compounded by weak regulatory enforcement and exploitation by large companies and intermediaries, marginalize small-scale traders and undermine the viability of fish-based livelihoods.
...
> Madalali wakubwa wamekua wakitusumbua kwa kupandisha bei ya samaki
...
Processing forms vary widely across different villages (Figure 65). Overall, smoking is the preferred method of fish processing. In four villages, namely Lyapinda, Mpasa, Tundu, and Kalungu smoking is the only method of fish processing. Sundrying also forms another method of fish processing, and is most frequently practiced in Kala, Manda Kerenge, and Manda Uhuru. In Kipili, sundrying and cold storage are the most common methods of fish processing. Cold storage facilities appear extremely limited in all other villages, except for Kilambo cha Mikolechi.
...
The equipment used to process fish is also varied (Figure 66). As smoking is the most common processing form, twigs and firewood are the most frequently listed equipment used as a fuel source. Cooking oil is also used in northern villages, but not in the southern cluster. Other equipment used includes wire mesh, corrugated iron sheets, nets, and refrigerators. Use of the latter appears extremely limited across both northern and southern villages. 
...
Fish processing of different species appears least affected by the seasons (Figure 66). Respondents in the southern village cluster indicated that most species are processed in all seasons. In the northern village cluster however, there appears a uniform distribution of responses, as approximately 20% process fish during all seasons, 40% during dry season, and 40% during the rainy season.
...
Sale prices of fish species also fluctuate for fish processors (Figure 68). The highest prices were fetched for Migebuka in the southern village cluster (TSh 20,785), Dagaa in the northern village cluster (TSh 20,745), and Dagaa in the southern village cluster (TSh 17,237). The lowest prices for these species were TSh 8,078 for Dagaa and TSh 8,516 for Migebuka in the northern village cluster, and TSh 14,777 for Dagaa and TSh 9,751 for Migebuka in the southern village cluster.
...
Overall, fish processors do not appear particularly satisfied. Satisfaction of their processing skills and business skills appeared highest. Fish processors appeared least satisfied with the support they receive from groups and/or organizations (Figure 69). 
...
```{r, fig.cap='Do you think your current processing activities are likely to support your needs over the long term (next 5 - 10 years)?', fig.align='center', out.width = '90%', fig.height=8}
# Expand the data with cluster classification
village_data_expanded <- tanganyika_survey %>%
...
Firstly, would you prefer we talk in English, or Kiswahili?

My name is _____ and I am conducting research on behalf of the TNC Tanganyika Project and would like to interview you today to better understand how things are in your area before the project starts. Your household was randomly selected for an interview.

ASK TO SPEAK TO THE HOUSEHOLD HEAD, OR IF THE HOUSEHOLD HEAD IS NOT THERE OR BUSY, ASK TO  SPEAK TO ANOTHER ADULT MEMBER OF THE HOUSEHOLD (18 OR OLDER)

You are being asked to take part in a household survey to understand people’s lives and livelihoods. We will be asking you about your household’s economic wellbeing, health, relationship with the environment, and relationship with the community. 

The interview will take about 60 minutes to complete. While there are no direct benefits to you, your views are important and you will be aiding in the decision-making regarding further programming conducted by the Tuungane project. Your answers will be recorded electronically or on paper. 

Please ask any questions you have now. If you have any questions during the interview, please hold these until after we have finished. If you have questions after today, you may contact the study leader XXX. 

Taking part in this study is completely voluntary. You may skip any questions that you do not want to answer or stop the interview at any time. If you agree to talk with us, the information will only be heard by me and seen by our analysis team after the interview.  We’ll not be sharing any data which would reveal a person’s race, health status, ethnic social origin, conscience, belief, genetic data, biometric data, property details, marital status, family details, sex, or sexual orientation. 


May we proceed with the interview?


After the survey: Thank you for the time that you have given us, we have brought a small token of appreciation.

\newpage

## Appendix 1 - Consent Form Kiswahili

Kwanza kabisa, ungependelea tuongee kwa Kiingereza, au Kiswahili?

Jina langu ni _____ na ninafanya utafiti kwa niaba ya Mradi wa TNC Tanganyika na ningependa kukuhoji leo ili kuelewa zaidi jinsi mambo yalivyo katika eneo lako kabla ya mradi kuanza. Kaya yako imechaguliwa bila mpangilio maalum kwa ajili ya mahojiano.

MAELEKEZO KWA MUULIZA MASWALI: OMBA KUONGEA NA MKUU WA KAYA, AU IWAPO MKUU WA KAYA HAYUPO AU ANA SHUGHULI, OMBA KUONGEA NA MWANAKAYA MWINGINE (MWENYE UMRI WA MIAKA 18 AU ZAIDI).

Unaombwa kushiriki katika utafiti wa kaya ili kuelewa maisha ya watu na shughuli zao. Tutakuwa tunakuuliza maswali kuhusu uwezo wa kaya yako kiuchumi, uhusiano na mazingira, raslimali za uvuvi na uhusiano na jamii. 

Mahojiano yanaweza kuchukua dakika 60 kukamilika. Ingawa hakuna manufaa ya moja kwa moja kwako, maoni yako ni ya muhimu na utakuwa unasaidia kwenye ufanyaji maamuzi kuhusu upangaji wa programu unaofanywa na mradi wa TNC. Majibu yako yatarekodiwa kwa njia ya kielektroniki au kwenye karatasi.

Tafadhali uliza maswali yoyote uliyo nayo mpaka hapa tulipofikia. Ikiwa utakuwa na maswali wakati wa mahojiano, tafadhali yaulize pale tutakapokuwa tumemaliza. Kama utakuwa na maswali baada ya leo unaweza kuwasiliana na kiongozi wa utafiti ………………………………………………….

Kushiriki katika utafiti huu ni kwa hiari kabisa. Unaweza kuruka maswali yoyote ambayo hutotaka kujibu au kusitisha mahojiano wakati wowote. Ikiwa unakubali kuzungumza nasi, taarifa utakazotupa zitasikilizwa na mimi tu na nakala zake za maandishi zitaonwa na timu yetu ya uchambuzi baada ya mahojiano. Hatutagawa data yoyote ambayo itafichua rangi ya  mtu, hali yake ya afya, asili yake ya kijamii, dhamiri, imani, data ya kinasaba au mwelekeo wa kijinsia.

Je, tunaweza kuendelea na mahojiano?
