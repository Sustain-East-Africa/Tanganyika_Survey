...
<!-- Provide information of survey design... -->
...
<!-- Building from experience with fishing other communities along the Tanzanian lakeshore -->
<!-- and acknowledging the pressing need to tackle these challenges while envisioning a -->
<!-- harmonious coexistence between communities and nature, the Lake Tanganyika Program -->
<!-- (LTP) was initiated. Through collaboration and innovative approaches, LTP aims to -->
<!-- establish and support a regional network of community-based co-managed fisheries areas -->
<!-- and empower communities to locally co-manage their fisheries, enhance fish value chains, -->
...
<!-- Enumerator Training -->
<!-- Training is crucial for enumerators before they begin a household survey to ensure that -->
<!-- data collection is accurate, consistent, and ethical. The training covers essential -->
<!-- responsibilities, including understanding the code of conduct, managing interview -->
<!-- confidentiality, handling incomplete or uncertain responses, and reviewing the -->
<!-- questionnaire at the end of each interview. -->
<!-- Enumerators also learn about their roles in relation to supervisors, debriefing sessions, and -->
<!-- data entry. Through detailed discussions of the survey's sections—ranging from household -->
<!-- information to livelihood practices—the enumerators gain a thorough understanding of -->
<!-- the questionnaire. Additionally, hands-on training in using tablets and survey software, -->

<!-- combined with testing the questions among themselves and a pilot study, prepares them -->
<!-- for real-world challenges, ensuring they can manage their workload and accurately capture -->
<!-- the data needed. -->


<!-- ## Pilot Study -->
<!-- Before the pilot study began, the training leads (OKK and ENVEX), supervisors, and the -->
<!-- TNC representatives paid a courtesy call to the offices of the District Executive Director, -->
<!-- and the District Commissioner for Nkasi, before heading to the field to begin the pilot -->
<!-- study. -->
<!-- The pilot study was conducted over two days, on October 10th and 11th, with a total of 43 -->
<!-- questionnaires finalised and submitted to the server. This study provided a platform to -->
<!-- refine all pending errors and issues, which were resolved before the main survey began on -->
<!-- Saturday, October 12th, 2024. -->
<!-- Some of the issues raised, particularly regarding the hardcopy questionnaire and the Open -->
...
total_row <- combined_table %>%
  ...
  mutate(
    Yes = paste0(round(Yes, 1), "%"),
    `Average years spent if not born` = round(`Average years spent if not born`, 1))
