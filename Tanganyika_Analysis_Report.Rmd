...
SEA_palette <- c("#3d5919",  "#5b7a2e",  "#a4b792", "#d2d2c8", "#b9c9b1", "#839c7a",  "#293c14", "#151d29", "#d77e5e", "#e6e7e2",  "#202C39", "#381D2A", "#000000", "#f2a084", "#f0f1ed", "#404b58", "#522a3b", "#1a1a1a", "#b15e42",   "#2a171e", "#3c3c3c")
...
```{r, fig.width=3}
# Data
data <- data <- readRDS("cluster_north_sample_design.rds")
...
```{r, fig.width=5}
# Data
data <- readRDS("cluster_south_sample_design.rds")
...
Overall, 64% of households in the survey live below the upper national poverty line. 26% of households live below the extreme poverty line (Table 7). 
...
Access to safe drinking water may depend on several variables including the source of the water and the ability to purify it. In this survey, responses were split between dry and rainy seasons, as water sources can change depending on the season. Water sources were categorized as improved or unimproved sources following WHO and UNICEF standards (NBS & ICF Macro, 2011). Improved sources include public taps, protected private or public wells, and rainwater. Unimproved sources include open wells and surface water.
...
Beds and mattresses are most commonly owned of the listed household goods (23% north and 19% south; Figure 9). Thereafter, mobile phones are owned by 19% of households in northern villages and 16% of villages in the southern cluster, respectively, a further 3% and 6% of respondents in the northern and southern villages clusters indicated owning a smartphone. This is significantly lower than the national average of 83% of households that own a mobile phone (2022 TDHSMIS). Radio ownership across the survey population (11%) was also significantly lower than both the 2011 Tuungane survey (75%) and the 2022 national average (44%; 2022 TDHSMIS). Solar panel ownership appears higher in the northern village cluster (20%) in comparison to the southern village cluster (13%).
...
Overall, approximately 18% of the households had borrowed money at least once in the previous year (Figure 11). The proportion of households that took out credit is highest in Kichangani and Wampembe and lowest in Ng’anga and Tundu.
...
Business expenses (17% north; 29% south) and farming expenses (21% north; 22%south) were the most common reasons for taking out a loan (Figure 12). In the northern village cluster, other common reasons for taking out a loan included covering household expenses (19%), food (20%), and medical expenses (15%). In the southern village cluster, it was slightly less common to take a loan out for household expenses (15%) and food (12%), whereas loans taken out for medical expenses (17%) were comparable to the northern villages cluster.
...
Half the borrowing households in the northern village cluster receive their loans from friends or neighbours and roughly a quarter of loans were given by family, compared to 38% from friends or neighbours and 20% from family in the southern village cluster (Figure 13). Community Conservation Banks (COCOBA), Savings and Credit Societies (SACCO), Fisher Committee (FICO), and Village Community Banks (VICOBA) accounted for 6% of loans given. COCOBA, SACCOS, and VICOBA all provide savings and loan schemes to groups of villagers.
...
The most common reason for not taking out a loan was the fear of being in debt, which was listed by 34% and 41% of respondents that didn’t borrow money in the past year in northern and southern village clusters respectively (Figure 14). A further 20% of respondents in northern villages and 15% in southern villages stated that they found the process of taking out a loan too difficult or had no need for doing so (approx. 16% in both clusters). 
...
Overall, 14% of household respondents across all villages in the southern cluster stated that they were a member of a COCOBA, SACCO, or FICO. Membership was highest in Manda Uhuru (30%). Only two villages of the northern cluster contained households with COCOBA/SACCO/FICO members, namely Katenge and Wampembe. 
...
Food shortages occurred amongst 60% and 64% of all households in northern and southern village clusters respectively during the last 12 months (Figure 20). In all villages, half or more than half of the household experienced at least one food shortage over the past 12 months. Shortages were most frequent in Manda Uhuru, where 95% of households were affected. 
...
When viewed over the period of the last five years, the trend in food availability appears the same (Figure 23). Overall, 18% of households in the northern village cluster and 15% in the southern village cluster experience better food availability, an estimated 54% experience the same availability of food, and 26% and 32% of households in northern and southern village clusters express being worse off now.  
...
The reasons for an increase in food availability vary (Figure 24). Roughly 33% of respondents attributed their increase in food availability to improvements in fish stocks. Reasons also pertained to agriculture, as 33% of respondents in the northern cluster and 25% in the southern cluster attributed the improvements to food availability to thriving crop harvests, whereas 19% of respondents across both clusters linked it to the use of fertilizer applied to their fields. Interestingly, a small subset of respondents linked their improvement in food availability to decreases in fish availability or destroyed crops, this may perhaps be related to a diversification in income or simply a misunderstanding.
...
The destruction of crops by bad weather and low fish availability were the two primary reasons for a decrease in household food availability (Figure 25). Crop damage could also be attributed to wildlife (6% north; 10% south) and pests (8% north; 5% south). Respondents also expressed other reasons and illness to have affected food availability negatively. 
...
Conflicts and/or disputes about fishing occur rarely, with three quarters of all household respondents in the northern cluster and 56% in the southern cluster stating that conflicts occur rarely or never (Figure 28). In total, 14% of respondents indicated that conflicts occur often in the northern cluster. Conflicts appear to happen more frequently in the southern village cluster, as 24% indicated conflicts occur often. Conflicts occur most often in Manda Kerenge (32%), Manda Uhuru (30%), and Mtakuja (29%). Positively, in the past year, the frequency of conflicts has decreased in most villages (Figure 29). Only in Katenge are there more conflicts than there were 12 months ago, as was indicated by 60% of respondents from the village. 
...
Approximately a quarter of all reasons for conflicts in the southern village cluster concern the closure of the lake to fishers or the conflicts surrounding the use of illegal fishing gear (Figure 30). In northern villages, 38% of households attributed conflicts to concern closure of the lake and 34% indicated conflicts to be about the use of illegal fishing gear. Fishing in protected breeding areas and the catching of undersized fish also contributed to conflicts, these reasons appeared higher in the southern village cluster as opposed to the north. 

Respondents were asked about other reasons that conflicts and/or disputes were about. Other conflict reasons described relate to permit challenges (n = 8), as some fishers appear to struggle with the high costs and complicated requirements for obtaining fishing licenses, including having to pay for multiple licenses for both the fisher and the boat. Furthermore, conflict may occur around instances of corruption and/or bribery of BMU officers (n = 2), arguments on the market surrounding fish pricing (n = 2), theft and security issues (n = 2).
...
In response to the question “Among whom do these disputes or conflicts mostly occur?”, respondents listed a few other options. Other parties listed among which disputes or conflicts occur include fishers and fisheries officers (n = 17) and include reasons such as conflict over illegal fishing, disagreements over payments and equipment provision, and conflicts regarding the lake closure. Fishers also experience disputes with government (n = 10), including national government, Nkasi district government, and the government of Izinga village. Furthermore, bandits (n = 3) were also listed as a conflict party.
...
```{r,  fig.cap='Influential community leaders', fig.align='center', out.width = '90%', fig.height=7, fig.width=8}
...
```{r, fig.cap='Influential leaders currently involved in a village, ward, or regional government position at village level (%)', fig.align='center', out.width = '90%', fig.height=9}
village_data <- tanganyika_survey %>%
...
Three quarters of all households in the southern cluster believed that their BMU had good leaders in place (Figure 40). In most instances (85%), respondents indicated that election procedures to choose BMU leaders were fair (Figure 41). Only 8% believed that BMU leaders were elected unfairly. Furthermore, two thirds of people indicated that there is good trust and collaboration between their BMU and government authorities in the management of fishing resources (Figure 42). Please note that the high confidence intervals observed in the northern cluster of figures 40, 41, and 42 can be attributed to the very low sampling size of respondents that had an awareness of BMUs (n = 4).
...
When asked whether BMUs have improved fishing practices, 44% of households in the southern cluster responded in agreement and a further 23% of households strongly agreed (Figure 45). Few people felt neutral about the impact of BMUs on fishing practices, but 28% of respondents either disagreed or disagreed strongly. In the northern cluster, two out of three respondents that knew about BMUs agreed that they indeed improved fishing practices. Please note the large confidence intervals in this cluster due to low sampling size. 
...
Overall, in both the northern and southern clusters of villages, canoes without engine are the most frequently used type of fishing boat (Figure 46). Only in Majengo Mapy and Ntanganyika are engine boats more frequently used than canoes without engine. In Izinga, fishers indicated using using large boats with an engine most frequently. Across village clusters, large boats with engine appear more frequently used in the northern villages.
...
Furthermore, fishers were asked to provide an indication of their relationship with fisheries extension officers. In the northern village cluster, 63% of respondents stated they had a good relationship, 20% described their relationship with fisheries extension officers as average, and a further 17% stated they maintained a bad relationship (Figure 50). Similarly, 65% of respondents in the southern village cluster indicated their relationship with fisheries extension officers to be good, while 18% described it as average, and 16% as bad. 
...
Half of fishers in the northern and southern village clusters indicated that they believed current fish stocks to be sufficient in meeting the fishing, food, and livelihood needs of their community (Figure 51). Respectively, a further 39% and 44% of fishers in the northern and southern village clusters did not believe this to be true.
...
In terms of the sustainability of current fishing practices on fish stocks, almost two thirds of fishers in southern villages believed there to be sufficient fish for communities in future (Figure 52). In contrast, merely half of the fishers in northern villages believed this statement to be true. Furthermore, 37% of fishers in the northern villages did not believe there would be enough fish whilst 16% weren’t sure. In southern villages, 30% of fishers did not think there will be sufficient fish for the communities in future. 
...
There appears to be a lot of variation in the type of fishing gear used at village level (Figure 53). Overall, however, ring nets (purse-seine) appear to be most commonly used across all villages in the northern and southern clusters. Thereafter, the use of gill nets, long lines, and lift nets is not uncommon. The use of long lines appears more common in northern villages than in southern villages, especially in Ng’anga and Mpasa is the use of long lines common. Interestingly, in Kipili more than two thirds of the fishing gear used is comprised of gill nets.

Respondents were asked to elaborate on the other types of fishing gear that they use. Other types of fishing gear listed by fishers include long lines, hooks, nets, as well as torches/lights, presumably for use at night. In one instance, diving equipment was mentioned.
...
Sale prices of fish appear to have fluctuated a lot in the past five years (Figure 55). Dagaa fetched the highest sale price in southern villages at TSh 21,039. In northern villages, the highest sale price for dagaa was TSh 17,868. Lowest sale prices for dagaa were estimated at TSh 9,958 in southern villages and TSh 6,744 in northern villages. The highest sale price for migebuka is estimated at TSh 14,570 in in northern villages and TSh 13,587 in southern villages. Migebuka sale prices reached as low as TSh 7,187 in northern villages and TSh 9,236 in southern villages. Interestingly, the average lowest price of sangara in southern villages appears higher than the average best price fetched for this species. However, there appears little variation in the two prices, which may indicate a relatively stable price for sangara over the past five years. This is corroborated by the limited variation observed in the price of sangara in northern villages.
...
Three quarters of fishers in the southern village cluster believe that BMUs are helpful to improving fishing practices (Figure 58). There are no estimates for this statistic in the northern village cluster as BMUs do not appear to be established yet. As such, fishing group membership of cooperatives, FICOs, COCOBA or savings groups across villages of the northern cluster appears to be very limited (Table 21).  Where fishermen were members of a group, practically all stated that these were supported by TNC and many indicated the group to be helpful.
...
In response to the question “What are the top three key changes to improve the group?”, fishing group members indicated the need for increased financial support and resources, such as providing capital or loans, and creating group laws to facilitate access to loans (n = 10). They also mentioned for the members themselves they need to be more accountable in paying their membership shares on time, encouraging timely repayment. Furthermore, respondents shared the need for increased education and training, including education on illegal fishing, entrepreneurship, and loans. They emphasized the importance of seminars and meetings for better management of activities. Furthermore, group members reiterated the need to increase access to improved fishing equipment, group and governance structures.

Two thirds of fishers in the southern village cluster di not feel that their current activities are likely to support their needs over the long term (Figure 59). There was no data available to gauge this statistic in the northern village cluster.
...
Although there exist different forms of fish traders, the majority of respondents simply labelled themselves as a trader, whereas a remaining 9% and 8% considered themselves to be someone who prepares fish in northern and southern village clusters (Figure 60). 
...
Trading of fish species can be bound to seasonal changes in climate and/or lake conditions. However, over the past five years, the majority of fish traders indicated that trading activities of fish species such as dagaa, kuhe, kungura, migebuka, ngege, and sangara may occur during all seasons (Figure 61). With the exception of dagaa, fish species in the northern village cluster are traded more frequently during the dry season. In northern villages, no dagaa is traded in the rainy season. In contrary, across the southern village cluster, the majority of dagaa is traded during the rainy season (42%). Likewise, rainy season trade is higher for all fish species across the southern villages in comparison to the northern cluster. Dry season trade of kuhe (56%), ngege (58%), and sangara (59%) appears particularly high in the northern village cluster. 
...
Sale prices of fish according to fish traders displayed notable variation. The highest sale prices are exhibited for dagaa and kungura in southern villages at TSh 18,904 and TSh 17,578 (Table 62). Respectively, the lowest price for dagaa is estimated at TSh 8,002 and TSh 9,700 for migebuka in southern villages. In the northern village cluster, the best price fetched for dagaa was TSh 15,988 and the lowest TSh 6,623. The highest price for kungura in the north was TSh 12,025 and TSh 6,261 at its lowest. Respectively, across the northern and southern cluster, the highest prices fetched for migebuka was TSh 14,617 and TSh 15,740. The lowest sale price for migebuka was TSh 8,153 and TSh 8,326 across northern and southern clusters respectively.
...
Satisfaction levels of fish traders was reflected that of fishers. Fish traders were most satisfied about their skills and business skills (Figure 63). Fish traders appeared least satisfied with the support they receive from groups and/or organizations, this is especially true for villages in the northern cluster.
...
As varied as the processing forms are at village level, are the equipment used to process fish (Figure 66). As smoking is the most common processing form, twigs and firewood are the most frequently listed equipment used as a fuel source. Cooking oil is also used in southern villages, but not in the northern cluster. Other equipment used includes wire mech, corrugated iron sheets nets, and refrigerators. Use of the latter appears extremely limited across both northern and southern villages. 
...
Fish processing of different species appears least affected by the seasons (Figure 66). Respondents in the northern village cluster indicated that most species are processed in all seasons. In the southern village cluster however, there appears a uniform distribution of responses, as approximately 20% process fish during all seasons, 40% during dry season, and 40% during the rainy season.
...
Sale prices of fish species also fluctuate for fish processors (Figure 68). The highest prices were fetched for migebuka in the northern village cluster (TSh 20,785), dagaa in the southern village cluster (TSh 20,745), and dagaa in the northern village cluster (TSh 17,237). The lowest prices for these species were TSh 8,078 for dagaa and TSh 8,516 for migebuka in the southern village cluster, and TSh 14,777 for dagaa and TSh 9,751 for migebuka in the northern village cluster.
...
Again, also fish processors appeared most satisfied with their own processing skills, business skills, and the tools and technologies they and least satisfied with the support they receive from groups and/or organizations (Figure 69). 
...
Three quarters of all fish processors did not believe that their current processing activities were likely to support their needs over the long term (Figure 70).

When asked whether they thought that their current activities are likely to support their needs over the long-term (next 5 - 10 years), fish processors felt their current activities were likely to support their long-term needs as they have a strong production capacity and the ability to access markets in a timely manner, which they believe will enable them to engage in activities sustainably in future. Others reported that their current activities are likely to support their long-term needs because they provide sufficient income to meet their family's basic needs, ensuring financial stability. Some stated that sustainable fishing practices would enhance processing activities, and they anticipated that their business would grow significantly, enabling them to generate sufficient income in the future.
